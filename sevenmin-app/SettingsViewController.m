...
@property (nonatomic, strong) PickerView *picker;
@end
...
- (void)viewDidLoad {
    ...
    self.settings = @[@"Whistle sound", @"Ticking sound", @"Repetition", @"Workout duration", @"Break duration"];
...
//    [tableView scrollToRowAtIndexPath:indexPath atScrollPosition:UITableViewScrollPositionTop animated:YES];
    ...
    self.picker = [PickerView pickerWithTitle:title currentValue:nil values:values];
    self.picker.currentValue = [[SettingsUtil sharedInstance]valueForKey:settingsKey];
    self.picker.completionBlock = ^(id selectedValue) {
